...
public class CoinCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender msgsender, Command command, String label, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase("coin")) {
            ...
            usage.append("> <player>");
            sender.sendMessage(ChatUtils.cc(prefix + "Balance: " + JuwerynCore.getPlugin().getCurrencyManager().getCoins(sender.getUniqueId())));
            sender.sendMessage(ChatUtils.cc(usage.toString()));
            ...
            if (args.length == 1) {
                ...
                if (args[0].equalsIgnoreCase("add")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "Usage: /coin add <player> <amount>"));
                    return true;
                }
                if (args[0].equalsIgnoreCase("remove")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "Usage: /coin remove <player> <amount>"));
                    return true;
                }
                if (args[0].equalsIgnoreCase("reset")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "Usage: /coin reset <player>"));
                    return true;
                }
                if (args[0].equalsIgnoreCase("set")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "Usage: /coin set <player> <amount>"));
                    return true;
                }
                ...
                if (args[0].equalsIgnoreCase("reset")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "You have reset" + target.getName() + "'s coins!"));
                    target.sendMessage(ChatUtils.cc(prefix + "Your coins have been reset by " + sender.getName() + "!"));
                    return true;
                }
                ...
                if (args[0].equalsIgnoreCase("add")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "You have added " + args[2] + " coins to " + target.getName() + "'s balance!"));
                    target.sendMessage(ChatUtils.cc(prefix + "You have been given " + args[2] + " coins by " + sender.getName() + "!"));
                    return true;
                }
                if (args[0].equalsIgnoreCase("remove")) {
                    if (!sender.hasPermission("juweryncore.coins.remove")) {
                    ...
                    if(JuwerynCore.getPlugin().getCurrencyManager().checkCoins(target.getUniqueId(), Integer.parseInt(args[2]))){
                        sender.sendMessage(ChatUtils.cc(prefix + "You have removed " + args[2] + " coins from " + target.getName() + "'s balance!"));
                        target.sendMessage(ChatUtils.cc(prefix +  args[2] + " coins were taken from your balance by " + sender.getName() + "!"));
                        return true;
                    } else {
                        sender.sendMessage(ChatUtils.cc(prefix + "You cannot remove more coins than " + target.getName() + " has!"));
                        return true;
                    }
                ...
                if (args[0].equalsIgnoreCase("set")) {
                    ...
                    sender.sendMessage(ChatUtils.cc(prefix + "You have set " + args[1] + "'s balance to " + args[2] + " coins!"));
                    target.sendMessage(ChatUtils.cc(prefix + "Your balance has been set to " + args[2] + " coins by " + sender.getName() + "!"));
                    return true;
                }
            }
